...
제1조 (목적)
본 약관은 에브리유니(이하 "서비스")가 제공하는 학교 커뮤니티 서비스의 이용 조건 및 절차, 이용자와 운영자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.

제2조 (정의)
① "서비스"란 에브리유니가 운영하는 학교 커뮤니티 플랫폼을 의미합니다.
② "이용자"란 본 약관에 동의하고 서비스를 이용하는 자를 의미합니다.
③ "게시물"이란 이용자가 서비스에 게재한 글, 사진, 영상, 댓글 등 모든 콘텐츠를 의미합니다.
④ "운영자"란 서비스를 관리·운영하는 자를 의미합니다.

제3조 (서비스 이용 자격)
① 본 서비스는 중학교 재학생 및 관계자를 대상으로 합니다.
② 만 14세 미만의 이용자가 본 약관에 동의하는 경우, 법정대리인(부모 또는 후견인)의 동의를 받은 것으로 간주합니다. 법정대리인은 언제든지 동의를 철회하고 해당 계정의 삭제를 요청할 수 있습니다.
③ 타인의 정보를 도용하여 가입하는 행위는 엄격히 금지되며, 발견 시 즉시 계정이 정지됩니다.
④ 한 사람이 여러 계정을 생성하는 행위는 금지됩니다.

제4조 (약관의 효력 및 변경)
① 본 약관은 서비스 화면에 게시하거나 이용자에게 공지함으로써 효력이 발생합니다.
② 운영자는 필요한 경우 약관을 변경할 수 있으며, 변경된 약관은 서비스 내 공지사항을 통해 사전 공지합니다.
③ 이용자가 변경된 약관에 동의하지 않을 경우 서비스 이용을 중단하고 탈퇴할 수 있습니다.
④ 변경 공지 후 7일 이내에 이의를 제기하지 않으면 동의한 것으로 간주합니다.

제5조 (서비스의 제공 및 변경)
① 운영자는 서비스를 연중무휴 24시간 제공하는 것을 원칙으로 합니다.
② 다음의 경우 서비스 제공이 일시 중단될 수 있습니다.
  - 서버 점검, 교체, 고장 등 기술적 문제
  - 천재지변, 국가 비상사태 등 불가항력
  - 기타 운영자가 불가피하다고 판단하는 경우
③ 서비스 내용이 변경되는 경우 사전 공지합니다.
④ 본 서비스는 학교의 공식 서비스가 아닌 학생 개인이 운영하는 커뮤니티입니다.

제6조 (이용자의 의무)
이용자는 다음 행위를 해서는 안 됩니다.
① 욕설, 비방, 모욕적 언어 사용
② 타인의 개인정보(이름, 연락처, 주소 등) 무단 게시
③ 허위사실 유포, 명예훼손, 사기
④ 성적으로 부적절하거나 음란한 콘텐츠 게시
⑤ 광고, 스팸, 홍보성 게시물 무단 게재
⑥ 다른 이용자에 대한 사이버 따돌림, 괴롭힘, 스토킹
⑦ 저작권이 있는 콘텐츠의 무단 게시 (교과서, 문제집, 학원 교재 등)
⑧ 타인의 계정 도용, 사칭
⑨ 서비스의 정상적인 운영을 방해하는 행위 (해킹, DoS 공격 등)
⑩ 관련 법령을 위반하는 행위

제7조 (게시물 관리)
① 이용자가 게시한 게시물의 내용에 대한 책임은 이용자 본인에게 있습니다.
② 운영자는 다음에 해당하는 게시물을 사전 통보 없이 삭제하거나 이동할 수 있습니다.
  - 제6조에 해당하는 게시물
  - 타인의 명예를 훼손하는 게시물
  - 개인정보가 포함된 게시물
  - 저작권을 침해하는 게시물
  - 기타 서비스의 운영 방침에 어긋나는 게시물
③ 삭제된 게시물은 복구되지 않습니다.

제8조 (제재 및 이용 제한)
① 경고 1회: 위반 게시물 삭제 및 경고 조치
② 경고 2~3회: 게시물 삭제 및 일정 기간 서비스 이용 제한
③ 경고 3회 이상: 계정 일시 정지 (7일~30일)
④ 중대한 위반 (개인정보 유출, 해킹 시도 등): 즉시 영구 계정 정지 및 법적 조치
⑤ 이용 제한에 이의가 있는 경우 운영자에게 문의할 수 있습니다.

제9조 (운영자의 책임 한계)
① 운영자는 천재지변, 전쟁, 기간통신사업자의 서비스 장애 등 불가항력으로 인한 서비스 장애에 대해 책임을 지지 않습니다.
② 운영자는 이용자가 서비스에 게재한 게시물로 인해 발생하는 분쟁에 대해 책임을 지지 않습니다.
③ 운영자는 이용자 상호 간의 분쟁에 개입하지 않으며, 이로 인한 손해에 대해 책임을 지지 않습니다.
④ 본 서비스는 비영리 목적으로 운영되며, 서비스 이용으로 발생하는 손해에 대해 운영자의 고의 또는 중대한 과실이 없는 한 책임을 지지 않습니다.
...
제11조 (준거법 및 관할)
본 약관은 대한민국 법률에 따라 규율되며, 분쟁 발생 시 관할 법원은 민사소송법에 따릅니다.`,
...
에브리유니(이하 "서비스")는 개인정보 보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률 등 관련 법령을 준수하며, 이용자의 개인정보를 보호하기 위해 최선을 다합니다.

제1조 (수집하는 개인정보 항목)
① 필수 수집 항목
  - 아이디, 이름, 생년월일, 비밀번호(암호화 저장)
② 선택 수집 항목
  - 이메일 주소, 학년, 반, 성별, 프로필 사진, 학교명
③ 소셜 로그인 시 수집 항목
  - 카카오: 카카오 계정 고유 ID, 이메일(선택), 프로필 사진(선택)
  - 구글: 구글 계정 고유 ID, 이메일, 프로필 사진
  - 네이버: 네이버 계정 고유 ID, 이메일(선택), 프로필 사진(선택)
④ 서비스 이용 과정에서 자동 수집되는 항목
  - IP 주소, 접속 일시, 서비스 이용 기록, 기기 정보

제2조 (개인정보 수집 목적)
① 회원 가입 및 관리: 본인 확인, 계정 관리, 부정 이용 방지
② 서비스 제공: 게시판, 채팅, 알림, 급식·시간표 등 맞춤 정보 제공
③ 계정 보안: 비밀번호 재설정, 이상 로그인 감지
④ 서비스 개선: 서비스 이용 통계 분석 및 개선
⑤ 법적 의무 이행: 관련 법령에 따른 의무 이행

제3조 (개인정보 보유 및 이용 기간)
① 회원 탈퇴 후 6개월 보관 후 완전 파기
  - 분쟁 해결 및 법적 의무 이행을 위해 6개월간 보관
  - 6개월 경과 후 이름, 이메일, 생년월일 등 개인식별정보 즉시 파기
② 관련 법령에 따른 보관
  - 전자상거래 소비자보호법: 계약/청약철회 기록 5년
  - 통신비밀보호법: 로그인 기록 3개월
③ 이용자가 탈퇴하더라도 작성한 게시글은 익명 처리 후 유지될 수 있습니다.
...
② 다음의 경우 예외적으로 제공될 수 있습니다.
  ...
  - 서비스 제공을 위해 필요한 최소한의 정보를 처리 위탁하는 경우

제5조 (개인정보 처리 위탁)
서비스는 원활한 운영을 위해 다음과 같이 개인정보를 처리 위탁합니다.
① Supabase (데이터베이스): 회원 정보 및 게시물 저장
② Cloudflare R2 (파일 저장소): 업로드 파일 저장
③ Resend (이메일 발송): 이메일 인증 및 비밀번호 재설정
④ 카카오, 구글, 네이버 (소셜 로그인): 소셜 계정 인증

제6조 (개인정보 보호 조치)
① 기술적 조치
  - 비밀번호: bcrypt 알고리즘으로 단방향 암호화 저장
  - 통신 구간: HTTPS/TLS 암호화
  - 접근 제어: JWT 토큰 기반 인증, IP 차단 시스템
  - 데이터베이스: Supabase RLS(행 수준 보안) 적용
② 관리적 조치
  - 개인정보 접근 권한 최소화
  - 정기적인 보안 점검
  - 개인정보 처리 로그 관리
...
① 개인정보 열람: 프로필 설정에서 확인
② 개인정보 수정: 프로필 설정에서 직접 수정
③ 개인정보 삭제(탈퇴): 설정 → 계정 탈퇴
④ 동의 철회: 서비스 탈퇴를 통해 동의 철회
⑤ 만 14세 미만의 경우 법정대리인이 위 권리를 대신 행사할 수 있습니다.

제8조 (쿠키 및 자동 수집)
① 서비스는 로그인 상태 유지를 위해 로컬스토리지(토큰)를 사용합니다.
② 이용자는 브라우저 설정을 통해 저장된 데이터를 삭제할 수 있습니다.

제9조 (개인정보 처리방침 변경)
① 본 방침은 시행일로부터 적용됩니다.
② 변경 시 서비스 내 공지사항을 통해 7일 전 사전 공지합니다.
③ 중요한 변경사항의 경우 이메일 또는 서비스 내 알림을 통해 안내합니다.`,
...
제1조 (이용자 게시물의 저작권)
① 이용자가 에브리유니에 게시한 콘텐츠(글, 사진, 영상, 댓글 등)의 저작권은 해당 이용자에게 귀속됩니다.
② 이용자는 자신이 게시한 콘텐츠에 대한 모든 법적 책임을 집니다.

제2조 (서비스 운영 목적 사용)
① 운영자는 서비스 운영, 개선, 홍보 목적으로 이용자 게시물을 사용할 수 있습니다.
② 단, 이 경우 이용자의 명예를 훼손하거나 개인정보를 침해하지 않습니다.
③ 이용자는 서비스 탈퇴 후 자신의 게시물에 대한 사용 허락을 철회할 수 있습니다.

제3조 (타인 저작물 게시 금지)
① 타인의 저작물(글, 사진, 영상, 음악, 교과서, 문제집 등)을 저작권자의 허락 없이 게시하는 것은 금지됩니다.
② 특히 다음 콘텐츠의 무단 게시는 엄격히 금지됩니다.
  - 교과서, 참고서, 문제집의 스캔본 또는 PDF
  - 학원 교재 및 프린트물
  - 타인이 제작한 요약 자료
  - 음악, 영화, 드라마 등 유료 콘텐츠
③ 위반 시 저작권법에 따라 민·형사상 책임을 질 수 있습니다.
④ 저작권 침해 게시물은 신고 후 즉시 삭제됩니다.

제4조 (허용되는 콘텐츠)
다음의 콘텐츠는 자유롭게 공유할 수 있습니다.
① 본인이 직접 작성하거나 제작한 자료
② 교육부, 교육청에서 공식 공개한 기출문제 및 학습자료
③ 공공누리 라이선스가 적용된 공공저작물
④ 저작권자의 명시적 허락을 받은 콘텐츠

제5조 (저작권 침해 신고)
① 저작권 침해가 의심되는 게시물을 발견한 경우 관리자에게 신고해주세요.
② 신고 접수 후 운영자는 해당 게시물을 검토하고 필요한 조치를 취합니다.
③ 허위 신고는 서비스 이용 제한의 사유가 될 수 있습니다.

제6조 (면책)
① 에브리유니는 이용자가 게시한 콘텐츠로 인한 저작권 분쟁에 대해 책임을 지지 않습니다.
② 저작권 침해로 인해 발생하는 모든 법적 책임은 해당 게시물을 작성한 이용자에게 있습니다.`
  }
};
